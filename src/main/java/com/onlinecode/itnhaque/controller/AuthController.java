...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO.UserGetAccount> getAccount() throws IdInvalidException {
        ...
        ResLoginDTO.UserLogin usResLoginDTO = new ResLoginDTO.UserLogin();
        ResLoginDTO.UserGetAccount userGetAccount = new ResLoginDTO.UserGetAccount();

        if (currentUserDB != null) {
            usResLoginDTO.setId(currentUserDB.getId());
            usResLoginDTO.setEmail(currentUserDB.getEmail());
            usResLoginDTO.setName(currentUserDB.getName());
            usResLoginDTO.setRole(currentUserDB.getRole().getName());
            userGetAccount.setUser(usResLoginDTO);
        }
    ...
    public ResponseEntity<ResLoginDTO> getRefreshToken(
        ...
        // create access token
        String access_token = this.securityUtil.createAccessToken(email, res.getUser().getRole());
        res.setAccessToken(access_token);

        // create refresh token
        String new_refresh_token = this.securityUtil.createRefreshToken(email, res.getUser().getRole());
